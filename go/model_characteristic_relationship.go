...
func AssertCharacteristicRelationshipRequired(obj CharacteristicRelationship) error {
	return nil
}

// AssertRecurseCharacteristicRelationshipRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of CharacteristicRelationship (e.g. [][]CharacteristicRelationship), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseCharacteristicRelationshipRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aCharacteristicRelationship, ok := obj.(CharacteristicRelationship)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertCharacteristicRelationshipRequired(aCharacteristicRelationship)
	})
}
