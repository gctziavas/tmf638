...
type ServiceAttributeValueChangeEvent struct {
	...
	Event ServiceAttributeValueChangeEventPayload `json:"event,omitempty"`
}

// AssertServiceAttributeValueChangeEventRequired checks if the required fields are not zero-ed
func AssertServiceAttributeValueChangeEventRequired(obj ServiceAttributeValueChangeEvent) error {
	if err := AssertServiceAttributeValueChangeEventPayloadRequired(obj.Event); err != nil {
		return err
	}
	return nil
}
...
// Accepts only nested slice of ServiceAttributeValueChangeEvent (e.g. [][]ServiceAttributeValueChangeEvent), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceAttributeValueChangeEventRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceAttributeValueChangeEvent, ok := obj.(ServiceAttributeValueChangeEvent)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceAttributeValueChangeEventRequired(aServiceAttributeValueChangeEvent)
	})
}
