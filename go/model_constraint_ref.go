...
func AssertConstraintRefRequired(obj ConstraintRef) error {
...
// Accepts only nested slice of ConstraintRef (e.g. [][]ConstraintRef), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseConstraintRefRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aConstraintRef, ok := obj.(ConstraintRef)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertConstraintRefRequired(aConstraintRef)
	})
}
