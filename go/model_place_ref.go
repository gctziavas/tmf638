...
// Accepts only nested slice of PlaceRef (e.g. [][]PlaceRef), otherwise ErrTypeAssertionError is thrown.
func AssertRecursePlaceRefRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aPlaceRef, ok := obj.(PlaceRef)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertPlaceRefRequired(aPlaceRef)
	})
}
