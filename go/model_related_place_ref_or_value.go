...
// Accepts only nested slice of RelatedPlaceRefOrValue (e.g. [][]RelatedPlaceRefOrValue), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseRelatedPlaceRefOrValueRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aRelatedPlaceRefOrValue, ok := obj.(RelatedPlaceRefOrValue)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertRelatedPlaceRefOrValueRequired(aRelatedPlaceRefOrValue)
	})
}
