...
// ServiceUpdate - Service is a base class for defining the Service hierarchy. All Services are characterized as either being possibly visible and usable by a Customer or not. This gives rise to the two subclasses of Service: CustomerFacingService and ResourceFacingService. Skipped properties: id,href,serviceDate
...
// Accepts only nested slice of ServiceUpdate (e.g. [][]ServiceUpdate), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceUpdateRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceUpdate, ok := obj.(ServiceUpdate)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceUpdateRequired(aServiceUpdate)
	})
}
