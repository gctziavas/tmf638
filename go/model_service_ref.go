...
// Accepts only nested slice of ServiceRef (e.g. [][]ServiceRef), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceRefRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceRef, ok := obj.(ServiceRef)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceRefRequired(aServiceRef)
	})
}
