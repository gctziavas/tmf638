...
type ServiceStateChangeEvent struct {
	...
	Event ServiceStateChangeEventPayload `json:"event,omitempty"`
...
func AssertServiceStateChangeEventRequired(obj ServiceStateChangeEvent) error {
	if err := AssertServiceStateChangeEventPayloadRequired(obj.Event); err != nil {
		return err
	}
	return nil
}
...
// Accepts only nested slice of ServiceStateChangeEvent (e.g. [][]ServiceStateChangeEvent), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceStateChangeEventRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceStateChangeEvent, ok := obj.(ServiceStateChangeEvent)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceStateChangeEventRequired(aServiceStateChangeEvent)
	})
}
