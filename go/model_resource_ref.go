...
// Accepts only nested slice of ResourceRef (e.g. [][]ResourceRef), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseResourceRefRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aResourceRef, ok := obj.(ResourceRef)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertResourceRefRequired(aResourceRef)
	})
}
