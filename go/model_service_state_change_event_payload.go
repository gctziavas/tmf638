...
type ServiceStateChangeEventPayload struct {

	Service Service `json:"service,omitempty"`
}

// AssertServiceStateChangeEventPayloadRequired checks if the required fields are not zero-ed
func AssertServiceStateChangeEventPayloadRequired(obj ServiceStateChangeEventPayload) error {
...
// Accepts only nested slice of ServiceStateChangeEventPayload (e.g. [][]ServiceStateChangeEventPayload), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceStateChangeEventPayloadRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceStateChangeEventPayload, ok := obj.(ServiceStateChangeEventPayload)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceStateChangeEventPayloadRequired(aServiceStateChangeEventPayload)
	})
}
