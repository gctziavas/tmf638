...
type ServiceAttributeValueChangeEventPayload struct {

	Service Service `json:"service,omitempty"`
}

// AssertServiceAttributeValueChangeEventPayloadRequired checks if the required fields are not zero-ed
func AssertServiceAttributeValueChangeEventPayloadRequired(obj ServiceAttributeValueChangeEventPayload) error {
...
// Accepts only nested slice of ServiceAttributeValueChangeEventPayload (e.g. [][]ServiceAttributeValueChangeEventPayload), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceAttributeValueChangeEventPayloadRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceAttributeValueChangeEventPayload, ok := obj.(ServiceAttributeValueChangeEventPayload)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceAttributeValueChangeEventPayloadRequired(aServiceAttributeValueChangeEventPayload)
	})
}
