...
// Accepts only nested slice of EntityValue (e.g. [][]EntityValue), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseEntityValueRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aEntityValue, ok := obj.(EntityValue)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertEntityValueRequired(aEntityValue)
	})
}
