...
// Accepts only nested slice of Place (e.g. [][]Place), otherwise ErrTypeAssertionError is thrown.
func AssertRecursePlaceRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aPlace, ok := obj.(Place)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertPlaceRequired(aPlace)
	})
}
