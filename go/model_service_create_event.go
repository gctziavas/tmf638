...
func AssertServiceCreateEventRequired(obj ServiceCreateEvent) error {
	if err := AssertServiceCreateEventPayloadRequired(obj.Event); err != nil {
		return err
	}
	return nil
}
...
// Accepts only nested slice of ServiceCreateEvent (e.g. [][]ServiceCreateEvent), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceCreateEventRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceCreateEvent, ok := obj.(ServiceCreateEvent)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceCreateEventRequired(aServiceCreateEvent)
	})
}
