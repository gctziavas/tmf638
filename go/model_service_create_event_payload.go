...
type ServiceCreateEventPayload struct {

	Service Service `json:"service,omitempty"`
}

// AssertServiceCreateEventPayloadRequired checks if the required fields are not zero-ed
func AssertServiceCreateEventPayloadRequired(obj ServiceCreateEventPayload) error {
...
// Accepts only nested slice of ServiceCreateEventPayload (e.g. [][]ServiceCreateEventPayload), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseServiceCreateEventPayloadRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aServiceCreateEventPayload, ok := obj.(ServiceCreateEventPayload)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertServiceCreateEventPayloadRequired(aServiceCreateEventPayload)
	})
}
